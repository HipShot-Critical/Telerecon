...
# Launcher code
print("\n")
print(f"{Fore.CYAN} __________________________________________________________________")  # noqa: E501
print(f"{Fore.CYAN}   _______ ______ _      ______ _____  ______ _____ ____  _   _    ")  # noqa: E501
print(Fore.CYAN + r"  |__   __|  ____| |    |  ____|  __ \|  ____/ ____/ __ \| \ | |   ")  # noqa: E501
print(Fore.CYAN + r"     | |  | |__  | |    | |__  | |__) | |__ | |   | |  | |  \| |   ")  # noqa: E501
print(f"{Fore.CYAN}     | |  |  __| | |    |  __| |  _  /|  __|| |   | |  | | . ` |   ")  # noqa: E501
print(Fore.CYAN + r"     | |  | |____| |____| |____| | \ \| |___| |___| |__| | |\  |   ")  # noqa: E501
print(Fore.CYAN + r"     |_|  |______|______|______|_|  \_\______\_____\____/|_| \_| v2.1")  # noqa: E501
print(f"{Fore.CYAN}___________________________________________________________________")  # noqa: E501
print(Style.RESET_ALL)
print(f"\n{Fore.YELLOW}Welcome to Telerecon, a scraper and reconnaissance framework for Telegram\n")  # noqa: E501
...
options = {
    ...
    "Collect user messages from a list of target channels": "usermultiscraper.py",  # noqa: E501
    ...
    "Scrape forwarding relationships into a list of target channel": "channellist.py",  # noqa: E501
    "Identify possible user associates via interaction network map": "network.py",  # noqa: E501
    ...
    "Conduct a subscriber census across a list of target channels": "census.py",  # noqa: E501
    "Parse user messages to extract ideological indicators": "indicators.py",
    "Parse user messages to extract indicators of capability and violent intent": "assessment.py",  # noqa: E501
}
